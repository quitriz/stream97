...
class LineItem {
  ...
  LineItem({this.id, this.image, this.name, this.parentName, this.productId, this.quantity, this.sku, this.subtotal, this.subtotalTax, this.taxClass, this.taxes, this.total, this.totalTax, this.variationId});
